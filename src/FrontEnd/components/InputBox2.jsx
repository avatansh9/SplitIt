    ...
    return (
        ...
        <div className="flex flex-col md:flex-row justify-around px-6 md:px-20 lg:px-32 items-center mt-10">
            ...
            <input placeholder={placeholder} value={value}  onChange={(e) => onchange(e)}
              className="w-50 pl-4 py-2 border cursor-pointer  rounded-3xl border-gray-700 focus:border-yellow-800 focus:ring-pink-700 outline-red-300 transiton-all duration-300"
            />
            </div>
