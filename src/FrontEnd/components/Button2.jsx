...
export const ButtonArray = () => {
  ...
  const handleAddMoney = () => {
    setTotalMoney(totalmoney + money); // Add money to total
    setAddMoney(0); // Reset the input box to 0
  };
  ...
  const splitMoney = () => {
    ...
    const transactionsList = finalUser(); // Get transaction list
    setTransactions(transactionsList); // Update state with transactions
    setAmountPerUser(totalsum / Users.length); // Update split amount
};
